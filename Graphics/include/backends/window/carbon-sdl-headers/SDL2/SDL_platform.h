...
#undef __MACOSX__
#define __MACOSX__  1
/* Real SDL2 only supports deploying on 10.7+ - irrelevant here: this vendored copy is
   types-only (SDL_Scancode/SDL_Event/etc for Window.hpp's public interface), never
   linked as a real library on this backend - see
   Graphics/include/backends/window/carbon-sdl-headers/README.md. Upstream's version
   guard doesn't apply to that use. */
